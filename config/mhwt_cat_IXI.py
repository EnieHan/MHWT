...
_C.MODEL.DEPTHS = (8, 8, 8, 8, 8, 8)
_C.MODEL.NUM_HEADS = (4, 4, 4, 4, 4, 4)
...
# loss
_C.LOSS = CN()
_C.LOSS.TYPE = 'THREE'  # THREE，L1
_C.LOSS.USE_MM_LOSS = False
_C.LOSS.ALPHA = 15
_C.LOSS.BETA = 0.1
_C.LOSS.GAMMA = 0.025
