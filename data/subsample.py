...
def create_mask_for_mask_type(mask_type_str, center_fractions, accelerations):  # [0.08] [4]
...
class MaskFunc(object):
    ...
    def __init__(self, center_fractions, accelerations):  # [0.08] [4]
        """
        Args:
...
class RandomMaskFunc(MaskFunc):
    ...
    def __init__(self, center_fractions, accelerations):
        super(RandomMaskFunc, self).__init__(center_fractions, accelerations)
